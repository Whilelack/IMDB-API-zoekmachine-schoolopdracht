...
#deze functie vragen aan de user welke informatie moet worden getoond
def get_user_input_directors():
...
def get_user_input_writers():
    user_input = input("Wil je de writers zien? y/n\n")
    print('\n')
    if user_input == 'y':
        get_writers()
    elif user_input != 'n' and user_input != '':
        print('het opgegeven woord is niet herkend')
        get_user_input_writers()

def get_user_input_genres():
    user_input = input("Wil je de genres zien? y/n\n")
    print('\n')
    if user_input == 'y':
        get_genres()
    elif user_input != 'n' and user_input != '':
        print('het opgegeven woord is niet herkend')
        get_user_input_genres()

def get_user_input_cast():
    user_input = input("Wil je de cast zien? y/n\n")
    print('\n')
    if user_input == 'y':
        get_cast()
    elif user_input != 'n' and user_input != '':
